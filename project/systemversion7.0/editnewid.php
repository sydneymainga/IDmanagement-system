...
<div class="container">
  ...
  <form action="editting.php" method="post">
  ...
  <div class="form-check">
   ...
   <!--<input type="radio" name="Status" value="<?php //echo $Status ; ?>">issued<br>-->
  
  </div>
<div class="form-check">
  
  <!--<input type="radio" name="Status" value="<?php //echo $Status ; ?>"> not issued<br>-->
  <input type="radio" name="Status" value="0"> ID Available<br>
</div>
  
  <button type="submit" name="update_newID" class="btn btn-primary">Update</button>
